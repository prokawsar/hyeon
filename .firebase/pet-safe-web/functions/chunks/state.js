import { I as InlangSdkException } from "./exceptions.js";
...
const initState = async (module) => {
  if (!config && false) {
    try {
      const { languages, referenceLanguage, resources } = await null;
      config = {
        referenceLanguage,
        languages,
...
export {
  getRuntimeFromLocals as a,
  addRuntimeToLocals as b,
  getResource as g,
  initState as i,
  reloadResources as r
};
