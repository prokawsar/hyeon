<script lang="ts">
	...
	const items: any = {
		...
		'온라인 문의': faGlobe,
		'찾아오시는 길': faLocationDot
	}
</script>

<button
	class="flex flex-col gap-3 justify-center text-white bg-primary-500 hover:bg-primary-400 w-full md:w-40 h-32 md:h-36 items-center rounded-2xl">
